...
--TABLA DE HORARIO
--INSERTAR
CREATE OR REPLACE PROCEDURE FIDE_INSERTAR_HORARIO_SP(
...
--MODIFICAR
CREATE OR REPLACE PROCEDURE FIDE_MODIFICAR_HORARIO_SP(
    P_ID_HORARIO IN FIDE_HORARIO_TB.ID_HORARIO%TYPE,
    P_DIA IN FIDE_HORARIO_TB.DIA%TYPE,
    P_HORA_INICIO IN FIDE_HORARIO_TB.HORA_INICIO%TYPE,
    P_HORA_FINAL IN FIDE_HORARIO_TB.HORA_FINAL%TYPE,
...
--ELIMINAR
CREATE OR REPLACE PROCEDURE FIDE_ELIMINAR_HORARIO_SP(
    P_ID_HORARIO IN FIDE_HORARIO_TB.ID_HORARIO%TYPE
)IS
BEGIN
    UPDATE FIDE_HORARIO_TB
...
--TABLA DIRECCION
--INSERTAR
CREATE OR REPLACE PROCEDURE FIDE_INSERTAR_DIRECCION_SP(
...
--MODIFICAR
CREATE OR REPLACE PROCEDURE FIDE_MODIFICAR_DIRECCION_SP(
P_ID_DIRECCION IN FIDE_DIRECCION_TB.ID_DIRECCION%TYPE,
P_DETALLE_DIRECCION IN FIDE_DIRECCION_TB.DETALLE_DIRECCION%TYPE,
P_ID_DISTRITO IN FIDE_DIRECCION_TB.ID_DISTRITO%TYPE,
P_ID_CANTON IN FIDE_DIRECCION_TB.ID_CANTON%TYPE,
...
--ELIMINAR
CREATE OR REPLACE PROCEDURE FIDE_ELIMINAR_DIRECCION_SP(
    P_ID_DIRECCION IN FIDE_DIRECCION_TB.ID_DIRECCION%TYPE
)IS
BEGIN
    UPDATE FIDE_DIRECCION_TB
...
--TABLA DE EMPRESA
--INSERTAR
CREATE OR REPLACE PROCEDURE FIDE_INSERTAR_EMPRESA_SP(
...
--MODIFICAR
CREATE OR REPLACE PROCEDURE FIDE_MODIFICAR_EMPRESA_SP(
    P_ID_EMPRESA IN FIDE_EMPRESA_TB.ID_EMPRESA%TYPE,
    P_NOMBRE_EMPRESA IN FIDE_EMPRESA_TB.NOMBRE_EMPRESA%TYPE,
    P_TELEFONO IN FIDE_EMPRESA_TB.TELEFONO%TYPE,
    P_CORREO IN FIDE_EMPRESA_TB.CORREO%TYPE,
...
--ELIMINAR
CREATE OR REPLACE PROCEDURE FIDE_ELIMINAR_EMPRESA_SP(
    P_ID_EMPRESA IN FIDE_EMPRESA_TB.ID_EMPRESA%TYPE
)IS
BEGIN
    UPDATE FIDE_EMPRESA_TB
...
--TABLA DE ENTREGA
--INSERTAR
CREATE OR REPLACE PROCEDURE FIDE_INSERTAR_ENTREGA_SP(
...
--MODIFICAR
CREATE OR REPLACE PROCEDURE FIDE_MODIFICAR_ENTREGA_SP(
   P_ID_ENTREGA IN FIDE_ENTREGA_TB.ID_ENTREGA%TYPE,
    P_FECHA IN FIDE_ENTREGA_TB.FECHA%TYPE,
    P_ID_DIRECCION IN FIDE_ENTREGA_TB.ID_DIRECCION%TYPE,
    P_ID_USUARIO IN FIDE_ENTREGA_TB.ID_USUARIO%TYPE,
...
--ELIMINAR
CREATE OR REPLACE PROCEDURE FIDE_ELIMINAR_ENTREGA_SP(
    P_ID_ENTREGA IN FIDE_ENTREGA_TB.ID_ENTREGA%TYPE
)IS
BEGIN
    UPDATE FIDE_ENTREGA_TB
...
--INSERTAR
CREATE OR REPLACE PROCEDURE FIDE_INSERTAR_DETALLE_ENTREGA_SP(
...
--MODIFICAR
CREATE OR REPLACE PROCEDURE FIDE_MODIFICAR_DETALLE_ENTREGA_SP(
   P_ID_DETALLE IN FIDE_DETALLE_ENTREGA_TB.ID_DETALLE%TYPE,
    P_DESCRIPCION IN FIDE_DETALLE_ENTREGA_TB.DESCRIPCION%TYPE,
    P_CANTIDAD IN FIDE_DETALLE_ENTREGA_TB.CANTIDAD%TYPE,
    P_ID_ENTREGA IN FIDE_DETALLE_ENTREGA_TB.ID_ENTREGA%TYPE,
...
--ELIMINAR
CREATE OR REPLACE PROCEDURE FIDE_ELIMINAR_DETALLE_ENTREGA_SP(
    P_ID_DETALLE IN FIDE_DETALLE_ENTREGA_TB.ID_DETALLE%TYPE
)IS
BEGIN
    UPDATE FIDE_DETALLE_ENTREGA_TB
...
--TABLA DE CATEGORIA
--INSERTAR
CREATE OR REPLACE PROCEDURE FIDE_INSERTAR_CATEGORIA_SP(
...
--MODIFICAR
CREATE OR REPLACE PROCEDURE FIDE_MODIFICAR_CATEGORIA_SP(
P_ID_CATEGORIA IN FIDE_CATEGORIA_TB.ID_CATEGORIA%TYPE,
P_NOMBRE_CATEGORIA IN FIDE_CATEGORIA_TB.NOMBRE_CATEGORIA%TYPE, 
P_ID_ESTADO IN FIDE_CATEGORIA_TB.ID_ESTADO%TYPE
)IS
...
--ELIMINAR
CREATE OR REPLACE PROCEDURE FIDE_ELIMINAR_CATEGORIA_SP(
P_ID_CATEGORIA IN FIDE_CATEGORIA_TB.ID_CATEGORIA%TYPE
)IS
    BEGIN
    UPDATE FIDE_CATEGORIA_TB
...
--INSERTAR
CREATE OR REPLACE PROCEDURE FIDE_INSERTAR_UNIDAD_MEDIDA_SP(
...
--MODIFICAR
CREATE OR REPLACE PROCEDURE FIDE_MODIFICAR_UNIDAD_MEDIDA_SP(
P_ID_UNIDAD_MEDIDA IN FIDE_UNIDAD_MEDIDA_TB.ID_UNIDAD_MEDIDA%TYPE,
P_NOMBRE_UNIDAD_MEDIDA IN FIDE_UNIDAD_MEDIDA_TB.NOMBRE_UNIDAD_MEDIDA%TYPE, 
P_ID_ESTADO IN FIDE_UNIDAD_MEDIDA_TB.ID_ESTADO%TYPE
)IS
...
--ELIMINAR
CREATE OR REPLACE PROCEDURE FIDE_ELIMINAR_UNIDAD_MEDIDA_SP(
P_ID_UNIDAD_MEDIDA IN FIDE_UNIDAD_MEDIDA_TB.ID_UNIDAD_MEDIDA%TYPE
)IS
    BEGIN
    UPDATE FIDE_UNIDAD_MEDIDA_TB
...
--TABLA DE PRODUCTO
--INSERTAR
CREATE OR REPLACE PROCEDURE FIDE_INSERTAR_PRODUCTO_SP(
...
--MODIFICAR
CREATE OR REPLACE PROCEDURE FIDE_MODIFICAR_PRODUCTO_SP(
   P_ID_PRODUCTO IN FIDE_PRODUCTO_TB.ID_PRODUCTO%TYPE,
    P_NOMBRE IN FIDE_PRODUCTO_TB.NOMBRE%TYPE,
    P_ID_CATEGORIA IN FIDE_PRODUCTO_TB.ID_CATEGORIA%TYPE,
    P_ID_UNIDAD_MEDIDA IN FIDE_PRODUCTO_TB.ID_UNIDAD_MEDIDA%TYPE,
...
--ELIMINAR
CREATE OR REPLACE PROCEDURE FIDE_ELIMINAR_PRODUCTO_SP(
    P_ID_PRODUCTO IN FIDE_PRODUCTO_TB.ID_PRODUCTO%TYPE
)IS
BEGIN
    UPDATE FIDE_PRODUCTO_TB
...
--TABLA DE INVENTARIO
--INSERTAR
CREATE OR REPLACE PROCEDURE FIDE_INSERTAR_INVENTARIO_SP(
...
--MODIFICAR
CREATE OR REPLACE PROCEDURE FIDE_MODIFICAR_INVENTARIO_SP(
   P_ID_INVENTARIO IN FIDE_INVENTARIO_TB.ID_INVENTARIO%TYPE,
    P_CANTIDAD IN FIDE_INVENTARIO_TB.CANTIDAD%TYPE,
    P_FECHA_INGRESO IN FIDE_INVENTARIO_TB.FECHA_INGRESO%TYPE,
    P_ID_PRODUCTO IN FIDE_INVENTARIO_TB.ID_PRODUCTO%TYPE,
...
--ELIMINAR
CREATE OR REPLACE PROCEDURE FIDE_ELIMINAR_INVENTARIO_SP(
    P_ID_INVENTARIO IN FIDE_INVENTARIO_TB.ID_INVENTARIO%TYPE
)IS
BEGIN
    UPDATE FIDE_INVENTARIO_TB
...
--INSERTAR
CREATE OR REPLACE PROCEDURE FIDE_INSERTAR_METODO_PAGO_SP(
...
--MODIFICAR
CREATE OR REPLACE PROCEDURE FIDE_MODIFICAR_METODO_PAGO_SP(
P_ID_METODO_PAGO IN FIDE_METODO_PAGO_TB.ID_METODO_PAGO%TYPE,
P_NOMBRE_METODO_PAGO IN FIDE_METODO_PAGO_TB.NOMBRE_METODO_PAGO%TYPE, 
P_ID_ESTADO IN FIDE_METODO_PAGO_TB.ID_ESTADO%TYPE
)IS
...
--ELIMINAR
CREATE OR REPLACE PROCEDURE FIDE_ELIMINAR_METODO_PAGO_SP(
P_ID_METODO_PAGO IN FIDE_METODO_PAGO_TB.ID_METODO_PAGO%TYPE
)IS
    BEGIN
    UPDATE FIDE_METODO_PAGO_TB
...
--TABLA DE FACTURA
--INSERTAR 
CREATE OR REPLACE PROCEDURE FIDE_INSERTAR_FACTURA_SP(
...
--MODIFICAR
CREATE OR REPLACE PROCEDURE FIDE_MODIFICAR_FACTURA_SP(
P_ID_FACTURA IN FIDE_FACTURA_TB.ID_FACTURA%TYPE,
P_FECHA_REGISTRO IN FIDE_FACTURA_TB.FECHA_REGISTRO%TYPE,
P_MONTO_TOTAL IN FIDE_FACTURA_TB.MONTO_TOTAL%TYPE,
P_SUBTOTAL IN FIDE_FACTURA_TB.SUBTOTAL%TYPE,
...
--ELIMINAR
CREATE OR REPLACE PROCEDURE FIDE_ELIMINAR_FACTURA_SP(
    P_ID_FACTURA IN FIDE_FACTURA_TB.ID_FACTURA%TYPE
)IS
BEGIN
    UPDATE FIDE_FACTURA_TB
...
--INSERTAR
CREATE OR REPLACE PROCEDURE FIDE_INSERTAR_DETALLE_FACTURA_SP(
...
--MODIFICAR
CREATE OR REPLACE PROCEDURE FIDE_MODIFICAR_DETALLE_FACTURA_SP(
    P_ID_DETALLE IN FIDE_DETALLE_FACTURA_TB.ID_DETALLE%TYPE,
    P_CANTIDAD IN FIDE_DETALLE_FACTURA_TB.CANTIDAD%TYPE,
    P_PRECIO_UNITARIO IN FIDE_DETALLE_FACTURA_TB.PRECIO_UNITARIO%TYPE,
    P_TOTAL IN FIDE_DETALLE_FACTURA_TB.TOTAL%TYPE,
...
--ELIMINAR
CREATE OR REPLACE PROCEDURE FIDE_ELIMINAR_DETALLE_FACTURA_SP(
    P_ID_DETALLE IN FIDE_DETALLE_FACTURA_TB.ID_DETALLE%TYPE
)IS
BEGIN
    UPDATE FIDE_DETALLE_FACTURA_TB
