...
CREATE TABLE FIDE_DIRECCION_TB (
    ...
    -- Clave primaria
    CONSTRAINT FIDE_DIRECCION_PK PRIMARY KEY (ID_DISTRITO),
    
    -- Unique para evitar repeticion de datos
    CONSTRAINT FIDE_DIRECCION_UBICACION_UNIQUE 
        UNIQUE (ID_DISTRITO, ID_CANTON, ID_PROVINCIA, ID_PAIS, ID_USUARIO),
...
CREATE TABLE FIDE_DETALLE_ENTREGA_TB (
    ...
    -- Clave primaria
    CONSTRAINT FIDE_DETALLE_ENTREGA_UNIQUE UNIQUE (ID_ENTREGA),
