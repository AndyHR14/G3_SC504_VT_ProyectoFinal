...
CREATE OR REPLACE VIEW FIDE_USUARIO_COLABORADOR_V AS
SELECT U.ID_USUARIO,
       U.NOMBRE,
       U.FECHA_REGISTRO,
       U.TELEFONO,
...
CREATE OR REPLACE VIEW FIDE_USUARIO_CLIENTE_V AS
SELECT U.ID_USUARIO,
       U.NOMBRE,
       U.FECHA_REGISTRO,
       U.TELEFONO,
...
LEFT JOIN FIDE_ESTADOS_TB ES ON ES.ID_ESTADO = E.ID_ESTADO;
...
CREATE OR REPLACE VIEW FIDE_ENTREGA_V AS
SELECT
    e.ID_ENTREGA,
...
FROM
    FIDE_ENTREGA_TB e
LEFT JOIN
    FIDE_DIRECCION_TB d ON d.ID_DIRECCION = e.ID_DIRECCION
LEFT JOIN
    FIDE_USUARIO_TB u ON u.ID_USUARIO = e.ID_USUARIO
LEFT JOIN
    FIDE_ESTADOS_TB s ON s.ID_ESTADO = e.ID_ESTADO;    
