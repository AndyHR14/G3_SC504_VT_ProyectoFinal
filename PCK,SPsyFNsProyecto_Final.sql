...
FUNCTION FIDE_ANIMALES_POR_TIPO_FN(P_TIPO IN NUMBER) 
RETURN VARCHAR2;
...
FUNCTION FIDE_DIRECCIONES_POR_USUARIO_FN(
  P_USUARIO IN NUMBER,
  P_DETALLE_DIRECCIONES OUT VARCHAR2
) RETURN NUMBER;
...
BEGIN
  ...
  LOOP
    ...
    V_CONTADOR := V_CONTADOR + 1;
    P_DETALLE_DIRECCIONES := P_DETALLE_DIRECCIONES || 'ID: ' || V_ID || 
                             ' | DETALLE: ' || V_DETALLE || 
                             ' | PAIS: ' || V_PAIS || 
                             ' | PROVINCIA: ' || V_PROVINCIA || CHR(10);
  END LOOP;
  CLOSE C_DIRECCIONES;
...
BEGIN
  ...
  LOOP
    ...
    V_RESULTADO := V_RESULTADO || 'DETALLE ID: ' || V_ID || 
                   ' | CANTIDAD: ' || V_CANTIDAD || 
                   ' | PRECIO: ' || V_PRECIO || 
